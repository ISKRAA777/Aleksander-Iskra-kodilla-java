...
//Uznano, że dobrze byłoby stworzyć system, który posiadałby zapisaną listę wszystkich lotów, np. GDAŃSK -> WROCLAW.
...
//3.	Znalezienie lotów poprzez inne miasto np. lot z Gdańska przez Kraków do Wroclawia
